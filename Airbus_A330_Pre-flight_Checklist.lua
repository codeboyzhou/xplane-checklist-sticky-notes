...
local text_start_y = 20 * 31
local text_delta_y = 20

function check_pre_flight_item()
    draw_string(text_start_x, text_start_y, '-------------------- PRE-FLIGHT CHECKLIST START ----------------------', 'yellow')
    draw_string(text_start_x, text_start_y + text_delta_y * (#checklist + 1), '-------------------- PRE-FLIGHT CHECKLIST END ------------------------', 'yellow')
...
add_macro('Show Pre-flight Checklist', 'show_pre_flight_checklist()')
