...
local pre_boarding_checklist_start_line = '-------------------- PRE-BOARDING CHECKLIST START --------------------'
local pre_boarding_checklist_ended_line = '-------------------- PRE-BOARDING CHECKLIST ENDED --------------------'

function check_pre_boarding_item()
  draw_string(text_start_x, text_start_y, pre_boarding_checklist_start_line, 'yellow')
  ...
  draw_string(text_start_x, text_start_y + text_delta_y * (#checklist + 1), pre_boarding_checklist_ended_line, 'yellow')
...
add_macro('Show Airbus-A330 Pre-boarding Checklist', 'show_pre_boarding_checklist()')
